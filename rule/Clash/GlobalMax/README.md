...
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/GlobalMax/GlobalMax.yaml
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/GlobalMax/GlobalMax_Domain.yaml
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/GlobalMax/GlobalMax_IP.yaml
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/GlobalMax/GlobalMax_Classical.yaml


稳定版：

https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/GlobalMax/GlobalMax.yaml
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/GlobalMax/GlobalMax_Domain.yaml
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/GlobalMax/GlobalMax_IP.yaml
https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/GlobalMax/GlobalMax_Classical.yaml
...
GlobalMax.yaml 请使用 behavior: "classical"。

GlobalMax_Classical.yaml 请使用 behavior: "classical"。

GlobalMax_Domain.yaml 请使用 behavior: "domain"。

GlobalMax_IP.yaml 请使用 behavior: "ipcidr"。

GlobalMax_Classical.yaml 可以单独使用，其他规则必须同时使用。

文件名带Resolve，指对于IP-CIDR、IP-CIDR6的规则，不增加no-resolve，其余与上述相同。

#### 最简单的用法

使用 GlobalMax_Classical.yaml。
